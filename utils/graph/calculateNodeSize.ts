import type { StringOrPrimitiveArray } from '@/types/graph'

interface Size { width: number, height: number }

function calculateLines(text: StringOrPrimitiveArray): string {
...
const sizeCache = new Map<StringOrPrimitiveArray, Size>()
...
export function calculateNodeSize(text: StringOrPrimitiveArray, isParent = false) {
